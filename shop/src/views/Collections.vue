<template>
  ...
  <el-page-header
        ...
        />
         ...
         <el-button type="primary" @click="deleteCollections" size="small">删除选中藏品</el-button>
      <!-- 商品 -->
        <div class="good">
          <el-alert title="我的收藏" type="success" :closable="false" center />
          <el-row>
            <el-col
  ...
  methods: {
    ...
    handleCheckAllChange(val) {
      ...
      deleteCollections(){
        ...
        request.delete("/deleteCollections/5/"+this.ids).then(res=>{
this.load()
        })
